...
export function Input({ label, value, onChange, onBlur, type = "text", readOnly = false, placeholder }: { label: string; value: string; onChange?: (v: string) => void; onBlur?: () => void; type?: string; readOnly?: boolean; placeholder?: string }) {
